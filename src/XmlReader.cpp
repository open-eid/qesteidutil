 ...
 * QEstEidUtil
 *
 * Copyright (C) 2011-2012 Jargo Kõster <jargo@innovaatik.ee>
 * Copyright (C) 2011-2012 Raul Metsma <raul@innovaatik.ee>
 *
...
QString XmlReader::emailErr( quint8 code )
{
	...
	case 20: return MainWindow::tr("No official email forwarding adresses was found");
	case 21: return MainWindow::tr("Your email account has been blocked. To open it, please send an e-mail to toimetaja@eesti.ee or call 663 0215.");
	case 22: return MainWindow::tr("Invalid e-mail address");
